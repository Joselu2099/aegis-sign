...
- **Biometric Matching and Liveness**: Implementación de lógica de correspondencia facial 1:1 y detección de vida (en fase de calibración).
...
| **RF-KYC-05** | Comparación Facial 1:1 | **Completado** | Matcher facial reactivo integrado. |
...
- **Pruebas**: 20+ pruebas unitarias y de arquitectura superadas. Pruebas de integración E2E estructuradas.
...
3. **Calibración Biométrica**: Ajustar el `matchThreshold` mediante pruebas con un dataset real de imágenes de diversas calidades.
